...
import com.xinlan.imageeditlibrary.ImageParentActivity;
 ...
 *         add new modules
 */
public class EditImageActivity extends ImageParentActivity {
    ...
    public static void start(Activity context, final String editImagePath, final String outputPath, final int requestCode) {
        if (TextUtils.isEmpty(editImagePath)) {
            ToastUtils.showShort(context, R.string.no_choose);
            return;
        }
    ...
    private final class SaveImageTask extends AsyncTask<Bitmap, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result) {
                ...
                ToastUtils.showShort(mContext, R.string.save_error);
            }
        }
    }//end inner class
