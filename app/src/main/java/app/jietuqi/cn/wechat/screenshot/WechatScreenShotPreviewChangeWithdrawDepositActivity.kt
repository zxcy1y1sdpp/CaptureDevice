...
class WechatScreenShotPreviewChangeWithdrawDepositActivity : BaseWechatActivity() {
    private var mMoney: Double = 0.0
    override fun setLayoutResourceId() = R.layout.activity_wechat_screenshot_preview_change_withdraw_deposit
