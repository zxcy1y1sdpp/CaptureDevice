...
import kotlinx.android.synthetic.main.activity_wechat_simulator_create_file.*
 ...
 * 用途： 创建文件
 */
class WechatSimulatorCreateFileActivity : BaseWechatSimulatorCreateActivity() {
    ...
    override fun setLayoutResourceId() = R.layout.activity_wechat_simulator_create_file
