 ...
 * 用途： 微信截图 -- 收红包
 */
class WechatScreenShotReceiveRedPacketActivity : BaseWechatActivity() {
    override fun setLayoutResourceId() = R.layout.activity_wechat_screenshot_receive_red_packet
