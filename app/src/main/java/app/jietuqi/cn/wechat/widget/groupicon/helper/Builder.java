package app.jietuqi.cn.wechat.widget.groupicon.helper;
...
import app.jietuqi.cn.wechat.widget.groupicon.layout.DingLayoutManager;
import app.jietuqi.cn.wechat.widget.groupicon.layout.ILayoutManager;
...
import app.jietuqi.cn.wechat.widget.groupicon.region.DingRegionManager;
import app.jietuqi.cn.wechat.widget.groupicon.region.IRegionManager;
import app.jietuqi.cn.wechat.widget.groupicon.region.WechatRegionManager;
...
public class Builder {
    ...
    public int placeholder  = R.drawable.head_default; // 获取图片失败时的默认图片
