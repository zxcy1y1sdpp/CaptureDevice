...
import app.jietuqi.cn.ui.wechatscreenshot.ui.create.WechatChoiceGroupHeaderActivity
import app.jietuqi.cn.util.LaunchUtil
import app.jietuqi.cn.util.OtherUtil
import kotlinx.android.synthetic.main.activity_wechat_simulator_create_invite_join_group.*
 ...
 */
@RuntimePermissions
class WechatSimulatorCreateInviteJoinGroupActivity : BaseWechatSimulatorCreateActivity(){
    private var mGroupInfoEntity =  WechatUserEntity()
    override fun setLayoutResourceId() = R.layout.activity_wechat_simulator_create_invite_join_group
