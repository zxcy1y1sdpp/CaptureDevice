...
import app.jietuqi.cn.wechat.widget.groupicon.cache.DiskLruCacheHelper;
import app.jietuqi.cn.wechat.widget.groupicon.cache.LruCacheHelper;
...
//                handler.obtainMessage(1, index, -1, bitmap).sendToTarget();
                handler.sendMessage(handler.obtainMessage(1, index, -1, bitmap));
            } else {
                handler.sendMessage(handler.obtainMessage(2, index, -1, null));
