...
import app.jietuqi.cn.entity.TitleEntity;

/**
 * 作者： liuyuanbo on 2019/1/29 17:19.
 * 时间： 2019/1/29 17:19
 * 邮箱： 972383753@qq.com
 * 用途：
 */
...
public class SectionDecoration extends RecyclerView.ItemDecoration {
    ...
    private List<TitleEntity> dataList;
    ...
    public SectionDecoration(List<TitleEntity> dataList, Context context, DecorationCallback decorationCallback) {
...
//        topGap = res.getDimensionPixelSize((int) (screenWidth * 0.0987));
//        //决定文本的显示位置等
//        alignBottom = res.getDimensionPixelSize(R.dimen.normalPadding2);
        topGap = res.getDimensionPixelSize(R.dimen.sticky_height);
        //决定文本的显示位置等
        alignBottom = res.getDimensionPixelSize(R.dimen.normalPadding);
    }
