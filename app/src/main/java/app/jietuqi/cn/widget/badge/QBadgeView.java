package app.jietuqi.cn.widget.badge;
...
//        mBadgeTextPaint.setFakeBoldText(true);
    ...
    private void initPaints() {
        ...
        Typeface customFont = FontCache.getTypeface("WeChatSansSS-Medium.ttf", mContext);
        mBadgeTextPaint.setTypeface(customFont);
    }
    ...
    private void drawBadge(Canvas canvas, PointF center, float radius) {
        ...
        if (mBadgeText.isEmpty() || mBadgeText.length() == 1) {
            ...
            mBadgeBackgroundRect.left = center.x - (mBadgeTextRect.width() / 2f + mBadgePadding * 1.1f);
            mBadgeBackgroundRect.top = center.y - (mBadgeTextRect.height() / 2f + mBadgePadding * 0.4f);
            mBadgeBackgroundRect.right = center.x + (mBadgeTextRect.width() / 2f + mBadgePadding * 1.1f);
            mBadgeBackgroundRect.bottom = center.y + (mBadgeTextRect.height() / 2f + mBadgePadding * 0.4f);
    ...
    @Override
    public Badge moreThan99(int type) {
        mMoreThan99 = type;
        return this;
    }
    /**
