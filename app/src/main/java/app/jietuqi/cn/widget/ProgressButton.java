...
/**
 * 作者： liuyuanbo on 2019/1/21 17:48.
 * 时间： 2019/1/21 17:48
 * 邮箱： 972383753@qq.com
 * 用途：
 */
public class ProgressButton extends AppCompatButton {
    ...
    private void initialize(Context context, AttributeSet attrs) {
        ...
        int defaultButtonColor = ContextCompat.getColor(context, R.color.colorGray);
        //Get default progress color
        int defaultProgressColor = ContextCompat.getColor(context, R.color.colorGreen);
        //Get default progress background color
        int defaultBackColor = ContextCompat.getColor(context,R.color.colorGray);
