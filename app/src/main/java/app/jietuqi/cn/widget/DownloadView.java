...
public class DownloadView extends View {
    ...
    private onDownloadViewStatusListener mOnDownloadViewStatusListener;
    ...
    private void init() {
        ...
        this.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mOnDownloadViewStatusListener != null) {
                    mOnDownloadViewStatusListener.onStart();
                }
            }
        });
    }
    ...
    public void setOnDownloadViewStatusListener(onDownloadViewStatusListener listener) {
        this.mOnDownloadViewStatusListener = listener;
    }
    ...
    private void initArgs() {
        ...
        if (heightValue == 0)
            heightValue = 50f;
        if (mBgColor == 0)
            mBgColor = Color.parseColor("#3182FF");
        if (mTextColor == 0)
        ...
        if (mProgressColor == 0)
            mProgressColor = Color.parseColor("#443182FF");
    ...
    public interface onDownloadViewStatusListener {
        void onStart();
    ...
    public void setProgress(int progress) {
        ...
        if (mProgress == 100) {
            ...
            mLoadAngleAnim.cancel();
            if (mOnDownloadViewStatusListener != null){
            	mOnDownloadViewStatusListener.onCancle();
			}
            return;
        }
        invalidate();
    ...
    public void stop() {
        ...
        if (mOnDownloadViewStatusListener != null) {
            mOnDownloadViewStatusListener.onPause();
        }
    }
    ...
    public void start() {
        ...
        if (mOnDownloadViewStatusListener != null) {
            mOnDownloadViewStatusListener.onContinue();
        }
    }
