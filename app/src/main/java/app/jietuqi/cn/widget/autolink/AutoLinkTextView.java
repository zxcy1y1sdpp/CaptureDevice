...
public class AutoLinkTextView extends AppCompatTextView {
    ...
    private static final int DEFAULT_COLOR = Color.parseColor("#5A6F9D");
//    private static final int DEFAULT_COLOR = Color.RED;
    ...
    private int number7ModeColor = DEFAULT_COLOR;
    ...
    public void setNumber7Color(@ColorInt int number7ModeColor) {
        this.number7ModeColor = number7ModeColor;
    }
