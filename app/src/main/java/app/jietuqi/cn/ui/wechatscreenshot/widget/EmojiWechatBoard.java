package app.jietuqi.cn.ui.wechatscreenshot.widget;
...
public class EmojiWechatBoard extends LinearLayout {
    ...
    public EmojiWechatBoard(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private int getPageSize() {
        return EmojiWechatManager.getSize() / (ROW * COLUMN - 1);
    }
        ...
        public EmojiPageAdapter() {
            ...
            for (int i = 0; i < pageSize; i++) {
                ...
                if (i < pageSize) {
                    ...
                    count = EmojiWechatManager.getSize() - start;
                }

                if (isInEditMode()) {
                    return;
                }
                final List<Integer> list = EmojiWechatManager.getResourceList(start, count);
