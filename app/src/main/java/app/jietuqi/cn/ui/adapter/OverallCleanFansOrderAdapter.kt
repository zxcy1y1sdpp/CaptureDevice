...
class OverallCleanFansOrderAdapter(val mList: ArrayList<OverallCleanFansListEntity>, val mType: Int) : RecyclerView.Adapter<OverallCleanFansOrderAdapter.Holder>() {
    ...
    inner class Holder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        private val iconIv: ImageView = itemView.findViewById(R.id.sGoodsIconIv)
        ...
        fun bind(entity: OverallCleanFansListEntity){
            if (mType == 0){
                iconIv.setImageResource(R.drawable.clean_fans_wechat)
            }else{
                iconIv.setImageResource(R.drawable.add_fans)
            }
