...
import kotlinx.android.synthetic.main.activity_wechat_create_video.*
 ...
 * 用途： 微信 -- 视频
 */
class WechatCreateVideoActivity : BaseWechatScreenShotCreateActivity(), ChangeWechatTransferDialog.OnItemSelectListener {
    override fun setLayoutResourceId() = R.layout.activity_wechat_create_video
