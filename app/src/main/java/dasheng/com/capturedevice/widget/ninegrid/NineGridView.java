package dasheng.com.capturedevice.widget.ninegrid;
...
public class NineGridView extends ViewGroup {
    ...
    private int gridWidth;      // 单张图片的宽图
    private int gridHeight;     // 单张图片的高度
...
//                gridWidth = gridHeight = (totalWidth - gridSpacing * 2) / 3;
    ...
    public void setAdapter(@NonNull NineGridViewAdapter adapter) {
        ...
        if (imageCount > 0){
            mFirstPicWhPercent = imageInfo.get(0).whPercentage;
            mFirstPicHeight = imageInfo.get(0).imageViewHeight;
            mFirstPicWidth = imageInfo.get(0).imageViewWidth;
        }
