...
//    void createTable(WechatTable userId);//创建数据表
//    void save(Object obj, int id); //保存数据
...
//    <T> T queryByHxId(Class<T> table, String id);//通过环信的id查找数据
...
//    void deleteAll(Collection collection); // 删除集合中所有的数据
     ...
     * @return
     */
//    <T>int updateUserInfo(Class<T> table, ChatWithOther entity, String whereClause, String[] whereArgs);
